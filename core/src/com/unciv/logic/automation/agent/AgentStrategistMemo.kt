...
data class AgentStrategistMemoMemory(
    ...
    var controlLanes: AgentStrategistControlLanes = AgentStrategistControlLanes(),
    var reviewContract: AgentStrategistReviewContract = AgentStrategistReviewContract(),
    ...
    var reviewVisibleRivalCapitals: Int = 0,
    ...
    constructor() : this(
        ...
        null,
        null,
        AgentStrategistDecisionFrame(),
        AgentStrategistControlLanes(),
        AgentStrategistReviewContract(),
        AgentCampaignControlLabels(),
        null,
        null,
        null,
        null,
...
data class AgentStrategistRefreshRequest(
    ...
    val triggerMetric: String? = null,
    val triggerWithinTurns: Int? = null,
)
