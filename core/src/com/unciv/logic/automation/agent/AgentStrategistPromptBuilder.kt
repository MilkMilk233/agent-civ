...
object AgentStrategistPromptBuilder {
    ...
    fun build(
        ...
        return """
            ...
            - unitSnapshots may include assignmentProgress when a unit is already carrying an ongoing role. Read role and status as the current operational job, assignmentSource as whether that job was explicit, carried forward, or auto-filled, and executionMode / completionPolicy as whether that job is real continuing automation or just notebook residue.
