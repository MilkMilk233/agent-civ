...
object AgentStrategicCheatSheetBank {
    ...
    private fun tinyDuelScience() = AgentStrategicCheatSheet(
        ...
        bullets = listOf(
            ...
            "Pottery and then Writing are the normal science opener line once the first city is stable enough to support it. If another tech is already active, preserve that science line and take the next science tech at the next research-choice boundary instead of talking as if future techs are already queued.",
            "No empire-level tech choice while another tech is already in progress is usually normal. Treat that as 'hold the science line until the next research-choice boundary', not as a strategic emergency by itself.",
