...
data class AgentMemory(
    ...
    fun clone(): AgentMemory = AgentMemory(
        ...
        lastStrategistMemo = lastStrategistMemo.copy(
            ...
            controlLanes = lastStrategistMemo.controlLanes.copy(
...
data class UnitAssignmentMemory(
    ...
    var assignmentSource: String = "explicit",
    ...
    constructor() : this(0, "", "", null, null, null, "explicit", "persistent", "memory_only", "until_stale", 0, 0)
}
