...
object AgentPromptBuilder {
    ...
    fun build(
        ...
        return """
            ...
            - Planner Brief JSON may include victoryIntent. Read effectiveWinPath as the current routed win path, militaryPurpose as what military is for right now, and economicPosture as the current empire posture.
            ...
            - If victoryIntent says militaryPurpose is deterrence or defense, do not turn visible rival contact into a conquest story unless the current brief shows real war emergency or a clear strategist pivot.
            ...
            - decisionFocus.mode may also use non-conquest labels such as defend_and_boom or deter_while_expanding. Read those as "keep the snowball growing while paying only for the military needed to stay safe."
            ...
            - If decisionFocus.supplySnapshot shows a positive unitSupplyDeficit or a unitSupplyProductionPenaltyPercent above 0, treat that as hard evidence that the empire is over the Civ V unit supply cap right now.
