...
object AgentPromptBuilder {
    ...
    fun build(
        ...
        return """
            ...
            - Planner Brief JSON already includes the current roadmap doctrine, phase, thesis, immediateObjectives, nearTermGoals, guardrails, and watchOuts.
            - Treat immediateObjectives as the strongest next-turn guidance, nearTermGoals as targets for the next few turns, and guardrails as true constraints that should already be preserved.
            ...
            - Planner Brief JSON includes tacticalPressure. Treat tacticalPressure.mustActReasons as hard current-turn pressure, then use tacticalPressure.priorityThisTurn to choose the best way to satisfy that pressure.
            ...
            - When nearTermGoals conflict with immediateObjectives, follow immediateObjectives first unless the board state makes them clearly stale.
            - Guardrails should stop reckless plans, but do not reinterpret future milestones as if they were already due this turn.
