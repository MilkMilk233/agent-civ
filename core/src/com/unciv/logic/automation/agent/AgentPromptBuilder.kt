...
object AgentPromptBuilder {
    ...
    fun build(
        ...
        return """
            ...
            The strategist has already reviewed the broader situation and wrote the roadmap briefing that you see inside Planner Brief JSON.
            ...
            - Planner Brief JSON already includes the current roadmap doctrine, phase, thesis, pastSummary, currentSituation, futurePlan, and tacticianHandoff.
            ...
            - Plan like a strong tactical player serving the roadmap. Reconstruct the current situation from the packets you were given, then choose the best exact legal actions for this turn.
            ...
            - If mustActNow includes a Settler that can found on its current tile and the roadmap still wants that city, founding it usually outranks routine observation moves.
            ...
            - If campaignContext shows a last-known rival target and the roadmap is pressuring that rival, march combat units toward that axis even if exact sight dropped this turn.
